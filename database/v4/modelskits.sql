...
--
-- Doublure de structure pour la vue `all_info_model`
-- (Voir ci-dessous la vue réelle)
--
DROP VIEW IF EXISTS `all_info_model`;
CREATE TABLE IF NOT EXISTS `all_info_model` (
`id` int
,`model` int
,`provider` int
...
--
-- Doublure de structure pour la vue `model_favorite`
-- (Voir ci-dessous la vue réelle)
--
DROP VIEW IF EXISTS `model_favorite`;
CREATE TABLE IF NOT EXISTS `model_favorite` (
`id` int
,`owner` int
,`model` int
,`modelName` varchar(255)
...
--
-- Doublure de structure pour la vue `model_full`
-- (Voir ci-dessous la vue réelle)
--
DROP VIEW IF EXISTS `model_full`;
CREATE TABLE IF NOT EXISTS `model_full` (
`id` int
,`name` varchar(255)
,`builder` int
,`category` int
...
--
-- Déchargement des données de la table `model_order`
--
...
--
-- Doublure de structure pour la vue `mymodels`
-- (Voir ci-dessous la vue réelle)
--
